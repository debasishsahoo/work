import { enrollCourse } from "@/services/api/apiCalls/enrollCourse";
...
const EnrollCourse: React.FC<{
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Enrollment successful! Admin will contact you soon.");
      onClose();
    } catch (error) {
        ...
        <div className="p-6 max-h-[80svh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end">
              ...
              disabled={loading}
                type="submit"
                className={`${loading? "cursor-not-allowed bg-gray-400 hover:bg-gray-600": "bg-kipm-crimson hover:bg-red-600 cursor-pointer" }  text-white px-6 py-2 rounded-md font-semibold text-sm transition-all duration-200 flex`}
              >
